...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Saurabh Pandey",bd=2,relief=SUNKEN)
...
lblfries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Samosa",fg="steel blue",bd=10,anchor='w')
lblfries.grid(row=1,column=0)
txtfries = Entry(f1,font=('ariel' ,16,'bold'), textvariable=Fries , bd=6,insertwidth=4,bg="powder blue" ,justify='right')
txtfries.grid(row=1,column=1)

lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Veg Thali",fg="steel blue",bd=10,anchor='w')
...
lblburger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Non- Veg Thali",fg="steel blue",bd=10,anchor='w')
...
lblCheese_burger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Vada Pau",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Veg Thali", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="40", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Non- Veg Thali", fg="steel blue", anchor=W)
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Vada Pau", fg="steel blue", anchor=W)
